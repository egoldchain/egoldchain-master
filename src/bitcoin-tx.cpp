...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s egoldchain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  egoldchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded egoldchain transaction") + "\n" +
              "  egoldchain-tx [options] -create [commands]   " + _("Create hex-encoded egoldchain transaction") + "\n" +
              "\n";
