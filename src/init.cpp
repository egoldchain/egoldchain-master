...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/egoldchain-project/egoldchain>";
    const std::string URL_WEBSITE = "<https://egoldchain.com>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Egoldchain version %s\n", FormatFullVersion());
}
