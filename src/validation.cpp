...
#if defined(NDEBUG)
# error "Egoldchain cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Egoldchain Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
			LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s EGC additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    CAmount nSubsidy = 0;//50 * COIN;
    if (nHeight == 1) nSubsidy = 5000000000 * COIN;
