...
{
	const char* pszTimestamp = "Egoldchain tech (shenzhen) Co., Ltd. Issued shares in 1 billion digital assets on 8/Oct/2017";
...
public:
    CTestNetParams() {
		...
		genesis = CreateGenesisBlock(1506737410, 293345, 0x1e0ffff0, 1, 50000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    CRegTestParams() {
		...
		genesis = CreateGenesisBlock(1506737410, 0, 0x207fffff, 1, 500000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
