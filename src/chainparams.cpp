...
public:
	...
	consensus.BIP34Hash = uint256S("00000000d97faabbbdf3af0cc346f5ae6a542d5a566f9208f5c01b60da69b0b4");
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // 1days
...
*/
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 2;//28;
...
*/
	...
	vSeeds.emplace_back("38.84.70.214", false);
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0x000000004be4b6f7d16fe602061bcc726d995d3b6c3717ee6129388707afae2f")},
            }
        };
/*
...
public:
    CTestNetParams() {
		...
		genesis = CreateGenesisBlock(1506737410, 293345, 0x1e0ffff0, 7, 50000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.egoldchaintools.com", true);
        vSeeds.emplace_back("seed-b.egoldchain.loshan.co.uk", true);
...
public:
    CRegTestParams() {
		...
		genesis = CreateGenesisBlock(1506737410, 0, 0x207fffff, 7, 500000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
